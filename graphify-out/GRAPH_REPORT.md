# Graph Report - tAsk-issue-187-web-settings-view  (2026-07-08)

## Corpus Check
- 250 files · ~99,039 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2146 nodes · 4479 edges · 116 communities (101 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2627d9c`
...
Cohesion: 0.20
Nodes (11): buildSettingsSummary(), buildSettingsWorkspaceRows(), buildTemplateSkillRows(), buildTemplateSkillSummary(), SettingsView(), TemplatesView(), ProjectSummary, TaskSkillSummary (+3 more)
...
Cohesion: 0.40
Nodes (5): buildMatrixCells(), buildMatrixColumns(), buildMatrixSummary(), MatrixView(), readLatestTaskUpdateLabel()
...
Cohesion: 0.06
Nodes (23): IconComponent, KanbanColumn, KanbanSummary, KanbanTaskCard, MatrixCell, MatrixColumn, MatrixSummary, MyTaskRow (+15 more)
...
Cohesion: 0.40
Nodes (5): compareMyTasks(), countRecentlyUpdatedTasks(), formatDateLabel(), formatOptionalDateLabel(), hasDateValue()

## Knowledge Gaps
- **709 isolated node(s):** `name`, `version`, `private`, `description`, `type` (+704 more)
