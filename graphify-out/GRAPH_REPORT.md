# Graph Report - tAsk-issue-189-web-agent-history-view  (2026-07-08)

## Corpus Check
- 250 files · ~99,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2149 nodes · 4484 edges · 109 communities (96 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32bb0d02`
...
Cohesion: 0.10
Nodes (21): TrustedCurrentUserId, toWorkspaceSummary(), TypeOrmWorkspaceReadStore, WorkspaceDetail, WorkspaceMember, WorkspaceSummary, createdAt, workspaceSummary (+13 more)
...
Cohesion: 0.08
Nodes (18): ApiTrustedCurrentUser(), parseTrustedCurrentUserId(), TrustedCurrentUserHeader, TrustedCurrentUserRequest, ApiDataSourceProvider, WorkspaceStatus, StatusesController, createdAt (+10 more)
...
## Knowledge Gaps
- **710 isolated node(s):** `name`, `version`, `private`, `description`, `type` (+705 more)
