# Graph Report - tAsk-issue-121-backend-telegram-context  (2026-07-07)

## Corpus Check
- 207 files · ~77,687 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1621 nodes · 3389 edges · 86 communities (75 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e45ec69`
...
- `createTaskMcpServer()` --calls--> `createAttachmentToolHandlers()`  [EXTRACTED]
  apps/mcp-server/src/mcp-server.ts → apps/mcp-server/src/attachment-tools.ts
- `createTaskMcpServer()` --calls--> `createCommentToolHandlers()`  [EXTRACTED]
  apps/mcp-server/src/mcp-server.ts → apps/mcp-server/src/comment-tools.ts
...
Cohesion: 0.09
Nodes (22): createTaskBackendClient(), normalizeBaseUrl(), ProjectDetailResponse, TaskBackendClientError, TaskBackendFetch, TaskBackendFetchInit, projectDetail, projectSummary (+14 more)
...
Cohesion: 0.10
Nodes (41): formatInvalidValue(), parseBackendBaseUrl(), InvalidTelegramBotEnvironmentError, loadTelegramBotConfig(), parseOptionalSecret(), parseRequiredSecret(), parseTelegramBotConfig(), TelegramBotConfig (+33 more)
...
Cohesion: 0.11
Nodes (29): attachmentWriteRoles, AgentRunEntity, AttachmentEntity, ConfirmationRequestEntity, InviteEntity, StatusEntity, TaskSkillEntity, TelegramChatEntity (+21 more)
...
Cohesion: 0.14
Nodes (17): CreateTaskCommentInput, CreateTaskCommentRequest, PreviewTaskSkillApplyResponse, TaskCommentResponse, TaskSummaryResponse, CommentCreateToolInput, CommentListToolInput, CommentToolHandlers (+9 more)
...
Cohesion: 0.14
Nodes (17): ApplyTaskSkillResponse, PreviewTaskSkillApplyInput, TaskSkillApplyRequest, createTaskSkillToolHandlers(), isUnknownRecord(), parseTaskSkillApplyToolInput(), readOptionalOverrides(), readOptionalStringArray() (+9 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (59): ApplyTaskSkillOperation, buildProjectTaskAssigneePath(), buildProjectTaskDueDatePath(), buildProjectTaskPath(), buildProjectTasksPath(), buildProjectTaskStatusPath(), buildTaskAttachmentLinksPath(), buildTaskAttachmentsPath() (+51 more)
...
Cohesion: 0.21
Nodes (11): TaskBackendClient, WorkspaceStatusResponse, createStatusToolHandlers(), isUnknownRecord(), parseStatusListToolInput(), readRecord(), readRequiredUuid(), StatusListToolInput (+3 more)
...
Cohesion: 0.12
Nodes (22): CreateProjectInput, CreateProjectRequest, ProjectSummaryResponse, TaskAttachmentResponse, createProjectToolHandlers(), isUnknownRecord(), parseProjectCreateToolInput(), parseProjectGetToolInput() (+14 more)
...
Cohesion: 0.12
Nodes (13): commentWriteRoles, ApiDataSource, ActivityEventEntity, CommentEntity, ProjectEntity, TaskEntity, TaskSkillVersionEntity, taskSkillWriteRoles (+5 more)
...
Cohesion: 0.08
Nodes (27): formatInvalidValue(), AttachmentsModule, CommentsModule, ProjectsModule, HealthResponse, HealthStatus, AppController, HealthResponseDto (+19 more)
...
## Knowledge Gaps
- **582 isolated node(s):** `name`, `version`, `private`, `description`, `type` (+577 more)
...
- **Why does `WorkspaceMemberEntity` connect `Community 50` to `Community 64`, `Community 66`, `Community 2`, `Community 72`, `Community 46`, `Community 80`, `Community 51`, `Community 63`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `UpdateTaskSkillMetadataInput` connect `Community 75` to `Community 68`, `Community 72`, `Community 49`, `Community 54`, `Community 57`, `Community 58`?**
